...
In the above, `depth_mode:=NFOV_UNBINNED` is set to be narrow field of view for increased distance in depth and `point_cloud_in_depth_frame = false` to render the pointcloud into the RBG image. 
